...
$vntResourceGroupName =     "{RESOURCE_GROUP_NAME}"     # Ex. rg-prde1core01
$batchAccountName =         "{BATCH_ACCOUNT_NAME}"      # Ex. batdeve1iaac01
$subscription =             "{SUBSCRIPTION_NAME}"       # Ex. HR_DEV_Subscription
$poolName =                 "{POOL_NAME}"               # Ex. bpdemo001
$virtualNetworkName =       "{VNET_NAME}"               # Ex. vnt-pe1core01
$batchSubnetName =          "{SUBNET_NAME}"             # Ex. sbt-10_0_5_0-24
...
##$userAccountName =          "{USER_ACCOUNT_NAME}"     # Ex. batch_admin
##$userDemoToken =            "{USER_ACOUNT_PASSWORD}"  # Ex. User password - or better use a vault reference
##$userRole =                 "admin"                   # This is either admin or user - 
                                                        #   there are also builtin admin and user roles
